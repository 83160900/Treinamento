...
public class TreinamentoApplication {
    ...
    public CommandLineRunner initData(IntegracaoRepository repository, 
        ...
        return args -> {
            // 0. Cadastrar Filiais
            filialRepository.save(new com.treinamento.model.Filial("001", "MATRIZ - SÃO PAULO", "AVENIDA PAULISTA", "1000", "SP", "SÃO PAULO", "12345678000199"));
            filialRepository.save(new com.treinamento.model.Filial("002", "FILIAL - RIO DE JANEIRO", "RUA DA ASSEMBLEIA", "10", "RJ", "RIO DE JANEIRO", "12345678000200"));
            ...
            com.treinamento.model.Escala e1 = null;
            com.treinamento.model.Escala e2 = null;
            if (h1 != null) {
                e1 = escalaRepository.save(new com.treinamento.model.Escala("001", "001", h1.getId(), "Útil", "Útil", "Útil", "Útil", "Útil", "Compensado", "DSR"));
            }
            if (h2 != null) {
                e2 = escalaRepository.save(new com.treinamento.model.Escala("002", "001", h2.getId(), "Útil", "Útil", "Útil", "Útil", "Útil", "Compensado", "DSR"));
            }
